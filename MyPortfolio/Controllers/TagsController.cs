...
namespace MyPortfolio.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Url,Description")] TagModel tagModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Url,Description")] TagModel tagModel)
        {
            if (ModelState.IsValid)
            {
